...
public void Random(){
    ...
    public boolean Add(String Book_ID, String Name,String Edition,String Publisher,String Price,String Pages ){
String sql="Insert into Book(Book_ID,Name,Edition,Publisher,Price,Pages) value(?,?,?,?,?,?)";
try{
   ...
   return true; } 
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153), 5), "New Book", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 153, 153))); // NOI18N
...
try{
    Boolean flag=Add(jTextField2.getText(),jTextField2.getText(), (String)jComboBox1.getSelectedItem(),jTextField4.getText(),jTextField5.getText(),jTextField6.getText());
    if(flag){
